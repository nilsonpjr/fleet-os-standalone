...
export default function WorkshopRequestsPage() {
  ...
  const { data: requests = [], loading, error } = useApi<FleetRequest[]>(() => 
    api.get('/api/fleet/requests/assigned')
  )
  ...
  const filtered = useMemo(() => {
    ...
    return requests.filter((r: any) =>
      (r.problem_description || r.problemDescription || '').toLowerCase().includes(needle) ||
              ...
              >
                <div className="flex gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="text-xs text-slate-500 line-clamp-1 max-w-md">
                      {(r as any).problem_description || r.problemDescription}
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between md:justify-end gap-6">
                  <div className="text-right">
                    ...
                    <div className="text-[10px] text-slate-500 font-bold">{fmtDate((r as any).created_at || r.createdAt)}</div>
                  </div>
